...
{
    /// <inheritdoc />
    public partial class PrimeiraMigration_ImplantacaoIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //    columns: table => new
            //    {
            //        FaccaoId = table.Column<int>(type: "int", nullable: false)
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_Faccao", x => x.FaccaoId);
            //    });
            ...
            //            .Annotation("SqlServer:Identity", "1, 1"),
            //        FaccaoId = table.Column<int>(type: "int", nullable: true),
            ...
            //        StatusRemessa = table.Column<int>(type: "int", nullable: false),
            //        Observacoes = table.Column<string>(type: "nvarchar(max)", nullable: true)
            //    },
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_Remessa", x => x.RemessaId);
            //    });
